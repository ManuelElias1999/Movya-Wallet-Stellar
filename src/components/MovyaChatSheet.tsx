...
const suggestions = ['¿Cuánto dinero tengo?', 'Envía 20 USDC a Ouali', 'Cambia 50 XLM a USDC'];
...
const styles = StyleSheet.create({
  flex: { flex: 1 }, sheet: { position: 'absolute', top: 0, right: 0, bottom: 0, left: 0, zIndex: 50, elevation: 20, overflow: 'hidden', backgroundColor: '#E5EDF5' }, chatBackdrop: { position: 'absolute', top: 0, right: 0, bottom: 0, left: 0, backgroundColor: '#E5EDF5' },
  header: { minHeight: 76, width: '100%', borderBottomLeftRadius: 27, borderBottomRightRadius: 27, paddingHorizontal: 14, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', overflow: 'hidden', borderBottomWidth: 1, borderColor: '#C2D2E2', backgroundColor: 'rgba(250,252,255,0.86)', shadowColor: colors.navy, shadowOpacity: 0.13, shadowRadius: 18, shadowOffset: { width: 0, height: 8 }, elevation: 7 }, closeButton: { width: 42, height: 42, borderRadius: 16, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#CCD9E6', alignItems: 'center', justifyContent: 'center' }, infoButton: { width: 42, height: 42, borderRadius: 16, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#CCD9E6', alignItems: 'center', justifyContent: 'center' },
  ...
  composerArea: { paddingHorizontal: 14, paddingTop: 11, paddingBottom: 12, overflow: 'hidden', backgroundColor: 'rgba(248,251,254,0.96)', borderTopWidth: 1, borderTopColor: '#BCCDDD', shadowColor: colors.navy, shadowOpacity: 0.1, shadowRadius: 14, shadowOffset: { width: 0, height: -5 } }, composer: { flexDirection: 'row', alignItems: 'flex-end', backgroundColor: '#FFFFFF', borderRadius: 25, borderWidth: 1.5, borderColor: '#B6CBE0', padding: 7, minHeight: 57, shadowColor: colors.navy, shadowOpacity: 0.09, shadowRadius: 9, shadowOffset: { width: 0, height: 4 } }, attachButton: { width: 39, height: 39, borderRadius: 15, backgroundColor: '#E7F0FA', alignItems: 'center', justifyContent: 'center' }, input: { flex: 1, color: colors.ink, fontSize: 14, maxHeight: 100, paddingVertical: 10, paddingHorizontal: 9 }, sendButton: { width: 43, height: 43, borderRadius: 16, backgroundColor: colors.brand, alignItems: 'center', justifyContent: 'center', shadowColor: colors.brand, shadowOpacity: 0.25, shadowRadius: 8, shadowOffset: { width: 0, height: 4 } }, micButton: { backgroundColor: '#E7F0FA' },
