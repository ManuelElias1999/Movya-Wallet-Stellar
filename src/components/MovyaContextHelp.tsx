...
const styles = StyleSheet.create({
  card: { flexDirection: 'row', alignItems: 'flex-start', backgroundColor: '#F7FBFF', borderRadius: 20, borderWidth: 1.5, borderColor: '#AFCFFF', padding: 13, shadowColor: colors.navy, shadowOpacity: 0.18, shadowRadius: 18, shadowOffset: { width: 0, height: 9 }, elevation: 6 },
  ...
  secondaryAction: { height: 32, justifyContent: 'center', paddingHorizontal: 11, borderRadius: 11, backgroundColor: '#E1EEFF', borderWidth: 1, borderColor: '#B9D4FF' }, secondaryText: { color: colors.brandDark, fontSize: 10, fontWeight: '800' }, primaryAction: { height: 32, flexDirection: 'row', alignItems: 'center', gap: 5, paddingHorizontal: 11, borderRadius: 11, backgroundColor: '#075DDE', shadowColor: colors.brandDark, shadowOpacity: 0.2, shadowRadius: 8, shadowOffset: { width: 0, height: 4 }, elevation: 3 }, primaryText: { color: '#FFFFFF', fontSize: 10, fontWeight: '800' }, close: { position: 'absolute', right: 8, top: 8, width: 27, height: 27, borderRadius: 10, backgroundColor: '#E8F1FF', alignItems: 'center', justifyContent: 'center' },
