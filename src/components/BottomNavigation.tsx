...
const styles = StyleSheet.create({
  ...
  centerSlot: { width: 70, height: 70, alignItems: 'center', justifyContent: 'flex-end' }, movyaButton: { position: 'absolute', top: -28, width: 66, height: 66, borderRadius: 24, alignItems: 'center', justifyContent: 'center', backgroundColor: '#FFFFFF', borderWidth: 3, borderColor: '#EAF3FF', shadowColor: colors.brandDark, shadowOpacity: 0.28, shadowRadius: 16, shadowOffset: { width: 0, height: 8 }, elevation: 12 }, movyaGlow: { position: 'absolute', width: 60, height: 60, borderRadius: 22, backgroundColor: '#DCEBFF' }, movyaLogo: { width: 60, height: 60, resizeMode: 'contain' }, movyaLabel: { color: colors.brand, fontSize: 9, fontWeight: '900', marginBottom: 4 },
});
