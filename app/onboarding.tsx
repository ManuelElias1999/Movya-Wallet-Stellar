...
function ChatPreview() {
  return (
    <View style={styles.phoneDemo}>
      ...
      <View style={[styles.focusHint, styles.focusHintRight]}><Text style={styles.focusHintText}>Escribe monto, token y contacto</Text><Ionicons color={colors.brand} name="arrow-down" size={16} /></View>
...
function ConfirmationPreview() {
  return (
    <View style={styles.phoneDemo}>
      <View style={styles.chatHeader}><Image source={require('../assets/movya-logo.png')} style={styles.chatLogo} /><View><Text style={styles.chatName}>Movya</Text><Text style={styles.chatStatus}>En línea</Text></View></View>
      <View style={styles.focusHint}><Ionicons color={colors.brand} name="arrow-down" size={16} /><Text style={styles.focusHintText}>Revisa los datos antes de confirmar</Text></View>
