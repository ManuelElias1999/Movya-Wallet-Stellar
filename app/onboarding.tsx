...
const steps = [
  ...
  { eyebrow: 'PASO 2', title: 'Escribe lo que quieres hacer', description: 'Indica el monto, el token y el contacto. No necesitas entrar al formulario de Enviar.' },
...
function ChatPreview() {
  return (
    <View style={styles.phoneDemo}>
      ...
      <View style={styles.movyaRow}><Image source={require('../assets/movya-logo.png')} style={styles.messageLogo} /><View style={styles.movyaMessage}><Text style={styles.movyaMessageText}>Hola, Manuel. ¿Qué deseas hacer?</Text></View></View>
