    ...
    <View style={styles.openPreview}>
      ...
      <View style={styles.tutorialFooter}>
        ...
        <View style={styles.tutorialItem}>
          <View style={styles.tutorialMovya}><AnimatedMovyaLogo showGlow={false} size={42} /></View>
...
function ChatPreview() {
  return (
    <View style={styles.phoneDemo}>
      <View style={styles.chatHeader}><View style={styles.chatLogo}><AnimatedMovyaLogo showGlow={false} size={39} /></View><View><Text style={styles.chatName}>Movya</Text><Text style={styles.chatStatus}>En línea</Text></View></View>
...
function DemoMessageLogo() {
  return <View style={styles.messageLogoRing}><Image source={require('../assets/movya-logo.png')} style={styles.messageLogo} /></View>;
}
