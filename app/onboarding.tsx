...
const steps = [
  ...
  { eyebrow: 'PASO 2 · DEMO CON OUALI', title: 'Escribe lo que quieres hacer', description: 'En este ejemplo enviarás 20 USDC a Ouali directamente desde el chat, sin entrar al formulario de Enviar.' },
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <BlurView intensity={74} tint="light" style={[styles.demoCard, Platform.OS === 'web' ? webGlass : null]}>
          <View style={styles.previewStack}>
            <View pointerEvents={step === 0 ? 'auto' : 'none'} style={[styles.previewLayer, step !== 0 && styles.previewHidden]}><OpenMovyaPreview /></View>
            <View pointerEvents={step === 1 ? 'auto' : 'none'} style={[styles.previewLayer, step !== 1 && styles.previewHidden]}><ChatPreview /></View>
            <View pointerEvents={step === 2 ? 'auto' : 'none'} style={[styles.previewLayer, step !== 2 && styles.previewHidden]}><ConfirmationPreview /></View>
            <View pointerEvents={step === 3 ? 'auto' : 'none'} style={[styles.previewLayer, step !== 3 && styles.previewHidden]}><SuccessPreview /></View>
          </View>
        </BlurView>
