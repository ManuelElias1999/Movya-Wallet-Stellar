    ...
    <View style={styles.openPreview}>
      ...
      <View style={styles.tutorialFooter}>
        ...
        <View style={styles.tutorialItem}>
          <View style={styles.tutorialMovya}><AnimatedMovyaLogo size={42} /></View>
...
const styles = StyleSheet.create({
  ...
  phoneDemo: { flex: 1, paddingVertical: 3 }, chatHeader: { flexDirection: 'row', alignItems: 'center', paddingBottom: 16, borderBottomWidth: 1, borderBottomColor: 'rgba(111,145,183,0.22)' }, chatLogo: { width: 39, height: 39, marginRight: 10 }, chatName: { color: colors.ink, fontSize: 14, fontWeight: '900' }, chatStatus: { color: '#16A071', fontSize: 9, fontWeight: '700', marginTop: 3 }, demoBadge: { alignSelf: 'flex-start', flexDirection: 'row', alignItems: 'center', gap: 5, marginTop: 18, paddingHorizontal: 10, paddingVertical: 7, borderRadius: 999, backgroundColor: '#E7F0FF', borderWidth: 1, borderColor: '#BED7FA' }, demoBadgeText: { color: colors.brandDark, fontSize: 8, fontWeight: '900', letterSpacing: 0.7 }, userMessage: { maxWidth: '78%', alignSelf: 'flex-end', marginTop: 24, borderRadius: 18, borderTopRightRadius: 5, paddingHorizontal: 14, paddingVertical: 11, backgroundColor: colors.brand, shadowColor: colors.brandDark, shadowOpacity: 0.19, shadowRadius: 9, shadowOffset: { width: 0, height: 5 } }, userMessageText: { color: '#FFFFFF', fontSize: 12, fontWeight: '700' }, movyaRow: { flexDirection: 'row', alignItems: 'flex-start', marginTop: 19 }, messageLogo: { width: 28, height: 28, marginRight: 9 }, movyaMessage: { flex: 1, borderRadius: 18, borderTopLeftRadius: 5, padding: 13, backgroundColor: 'rgba(255,255,255,0.78)', borderWidth: 1, borderColor: '#C5DDFB' }, movyaMessageText: { color: colors.text, fontSize: 11, lineHeight: 17 }, reviewCard: { marginTop: 12, padding: 13, borderRadius: 16, backgroundColor: 'rgba(232,241,255,0.92)', borderWidth: 1, borderColor: '#BDD7FA' }, reviewRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 5 }, reviewLabel: { color: colors.muted, fontSize: 9 }, reviewValue: { color: colors.ink, fontSize: 10, fontWeight: '800' }, fakeComposer: { height: 54, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 13, gap: 9, marginTop: 'auto', borderRadius: 20, backgroundColor: 'rgba(255,255,255,0.72)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.9)' }, fakeComposerText: { flex: 1, color: colors.muted, fontSize: 10 }, fakeSend: { width: 32, height: 32, borderRadius: 11, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.brand },
