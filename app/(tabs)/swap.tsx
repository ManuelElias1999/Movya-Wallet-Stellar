...
const styles = StyleSheet.create({
  safeArea: { flex: 1, backgroundColor: colors.pageBackground }, content: { padding: 20, paddingBottom: 40 }, label: { color: colors.text, fontSize: 13, fontWeight: '800', marginTop: 18, marginBottom: 9 },
  assetBox: { height: 60, flexDirection: 'row', alignItems: 'center', backgroundColor: '#FFFDFB', borderWidth: 1.5, borderColor: '#D9D1E7', borderRadius: 18, paddingHorizontal: 14, shadowColor: colors.navy, shadowOpacity: 0.07, shadowRadius: 10, shadowOffset: { width: 0, height: 5 }, elevation: 2 }, assetDot: { width: 32, height: 32, borderRadius: 11, marginRight: 11 }, usdc: { backgroundColor: '#2775CA' }, xlm: { backgroundColor: colors.navy }, assetName: { flex: 1, color: colors.ink, fontSize: 14, fontWeight: '700' }, code: { color: colors.muted, fontSize: 12, fontWeight: '800' },
  amountBox: { height: 86, flexDirection: 'row', alignItems: 'center', backgroundColor: '#EAF3FF', borderWidth: 1.5, borderColor: '#BFD5F3', borderRadius: 20, paddingHorizontal: 17, marginTop: 10, shadowColor: colors.navy, shadowOpacity: 0.08, shadowRadius: 12, shadowOffset: { width: 0, height: 6 }, elevation: 2 }, amountInput: { flex: 1, color: colors.ink, fontSize: 34, fontWeight: '800' },
  ...
  outputBox: { height: 86, flexDirection: 'row', alignItems: 'center', backgroundColor: '#EFEAFF', borderWidth: 1.5, borderColor: '#D7CCF5', borderRadius: 20, paddingHorizontal: 17, marginTop: 10 }, output: { flex: 1, color: colors.ink, fontSize: 34, fontWeight: '800' },
