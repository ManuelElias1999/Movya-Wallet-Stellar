...
const styles = StyleSheet.create({
  ...
  outputBox: { height: 76, flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(242,237,255,0.94)', borderWidth: 1.5, borderColor: '#D3C7F5', borderRadius: 21, paddingLeft: 15, paddingRight: 10, marginTop: 10, shadowColor: colors.navy, shadowOpacity: 0.14, shadowRadius: 14, shadowOffset: { width: 0, height: 7 }, elevation: 4 },
  output: { flex: 1, color: colors.ink, fontSize: 30, fontWeight: '800' },
  outputToken: { borderColor: '#D8CCF6' },
