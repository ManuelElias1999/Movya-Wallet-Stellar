      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.addressCard}>
          ...
          <View style={styles.actions}>
            <PressableScale onPress={copyAddress} style={styles.actionButton}>
            ...
            <PressableScale onPress={shareAddress} style={[styles.actionButton, styles.shareButton]}>
...
const styles = StyleSheet.create({
  safeArea: { flex: 1, backgroundColor: '#E8F1FF' }, content: { padding: 20, paddingBottom: 40, alignItems: 'center' },
  ...
  addressCard: { width: '100%', backgroundColor: '#FFFDFB', borderRadius: radius.md, borderWidth: 1.5, borderColor: '#D9D1E7', padding: 17, marginTop: 16, shadowColor: colors.navy, shadowOpacity: 0.08, shadowRadius: 12, shadowOffset: { width: 0, height: 6 }, elevation: 2 }, addressLabel: { color: colors.muted, fontSize: 11, fontWeight: '700' }, address: { color: colors.ink, fontSize: 13, lineHeight: 19, fontWeight: '600', marginTop: 8 },
  actions: { flexDirection: 'row', gap: 9, marginTop: 14 },
  actionButton: { flex: 1, height: 45, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: colors.brandSoft, borderRadius: 15, shadowColor: colors.navy, shadowOpacity: 0.11, shadowRadius: 9, shadowOffset: { width: 0, height: 5 }, elevation: 3 },
